...
class TrainingCollector(MetricCollector):
    ...
    def summary(self) -> Dict[str, Any]:
        ...
        w_loss = float(sum(w*l for w, l in zip(weights, loss_list))) if loss_list else None
        w_dice = float(sum(w*d for w, d in zip(weights, dice_list))) if dice_list else None
